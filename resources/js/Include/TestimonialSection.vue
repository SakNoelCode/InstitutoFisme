                                    ...
                                    <div class="w-full">
                                        <div>
                                            ...
                                            <p class="mb-2 text-base font-medium italic text-body-color sm:text-lg">
                                                ...
                                                fusionan para crear nuevas
                                                perspectivas, has llegado al lugar indicado.
                                            </p>

                                            <p class="mb-11 text-base font-medium italic text-body-color sm:text-lg">

                                                ¡La revolución tecnológica te espera!
                                            </p>

                                            <h4 class="text-xl font-semibold text-dark">
                                                Dr. Carlos Alberto Rios Campos
                                            </h4>
                                            <p class="text-base text-body-color">
                                                Encargado del Instituto de Investigación en Tecnología de Información y
                                                Comunicación (IITC).
                                            </p>
                                        </div>
                                    </div>
