                ...
                <div class="w-full px-4">
                    <div class="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-5">
                        ...
                        <p class="text-base text-body-color">
                            Estas declaraciones representan nuestro compromiso
                            con nuestros valores y principios, y nos ayudan a mantener el rumbo hacia el
                            éxito y el crecimiento continuo.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="-mx-4 flex flex-wrap justify-center">
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div
                        ...
                        <h2 class="mb-5 text-[42px] font-bold text-primary">
                            Misión
                        </h2>
                        <p class="mb-8 border-b border-[#F2F2F2] pb-8 text-base text-body-color">
                            Descubrir, interpretar, revisar y difundir el conocimiento científico en el campo
                            de las tecnológicas a fin de desarrollar una cultura de sabiduría e
                            investigación entre los miembros de la Facultad de Ingeniería
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div
                        ...
                        <p class="mb-8 border-b border-[#F2F2F2] pb-8 text-base text-body-color">
                            Ser el instituto de Investigación líder a nivel nacional en la generación de conocimiento científico y 
                            tecnológico de calidad, orientado a contribuir con el progreso 
                            de la sociedad, a fin de mejorar la calidad de vida de la población.
                        </p>
                        <div>
                            <span class="absolute right-0 top-7 z-[-1]">
                                <svg width="77" height="172" viewBox="0 0 77 172" fill="none"
