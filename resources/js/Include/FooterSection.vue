        ...
        <div class="container mx-auto">
            <div class="-mx-4 flex flex-wrap">
                ...
                <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                    <div class="mb-10 w-full">
                        <h4 class="mb-9 text-lg font-semibold text-dark">Contacto</h4>
                        <ul>
                            <li>
                ...
                <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                    <div class="mb-10 w-full">
                        <h4 class="mb-9 text-lg font-semibold text-dark">Encargado</h4>
                        <ul>
                            <li>
                                <a href="javascript:void(0)"
                                    class="mb-2 inline-block text-base leading-loose text-body-color hover:text-primary">
                ...
                <div class="w-full px-4 sm:w-2/2 lg:w-4/12">
                    <div class="mb-10 w-full">
                        <h4 class="mb-9 text-lg font-semibold text-dark">Síguenos en</h4>
                        ...
                        <p class="text-base text-body-color">&copy; 2023 IITIC</p>
                    </div>
                </div>
            </div>
        </div>
