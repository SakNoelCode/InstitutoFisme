...
<template>
    ...
    <footer class="relative z-10 bg-blue-900 pt-20 pb-5 lg:pt-[100px] lg:pb-5">
        <div class="container mx-auto">
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4 sm:w-2/3 lg:w-4/12">
                    <div class="mb-10 w-full">
                        ...
                        <p class="flex items-center text-sm font-medium text-white">
                            ...
                            <span>+ (51) 998 768 321</span>
                        </p>
                    </div>
                </div>
                <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                    <div class="mb-10 w-full">
                        <h4 class="mb-9 text-lg font-semibold text-white">Contacto</h4>
                        <ul>
                            <li>
                                <a href="javascript:void(0)"
                                    class="mb-2 inline-block text-base leading-loose hover:text-white"
                                    style="color: #ccc;">
                                    Jr. Libertad #1300
                                </a>
                            </li>
                ...
                <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                    <div class="mb-10 w-full">
                        <h4 class="mb-9 text-lg font-semibold text-white">Encargado</h4>
                        <ul>
                            <li>
                                <a href="javascript:void(0)"
                                    class="mb-2 inline-block text-base leading-loose hover:text-white"
                ...
                <div class="w-full px-4 sm:w-2/2 lg:w-4/12">
                    <div class="mb-10 w-full">
                        <h4 class="mb-9 text-lg font-semibold text-white">Síguenos en</h4>
